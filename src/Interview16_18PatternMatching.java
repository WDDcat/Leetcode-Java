...
public class Interview16_18PatternMatching {
	public boolean patternMatching(String pattern, String value) {
		...
		for(int aLength = 0; aLength * aCount <= vLength; aLength++) {
			...
			if((vLength - aCount * aLength) % bCount != 0) continue;
			...
			if(match && !aString.equals(bString)) return true; 
		}
		return false;
    }
}
